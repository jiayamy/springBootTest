package com.servant.wiki.worker.config.redis;
...
public class JedisTemplate {
	...
	/**
	 * Get the value of the specified key. If the key does not exist null is
	 * returned. If the value stored at key is not a byte[] an error is returned
	 * because GET can only handle byte[] values.
	 */
	...
	/**
	 * Set the byte[] value as value of the key.
	 * The byte[] can't be longer than 1073741824 bytes (1 GB).
	 */
	...
	/**
	 * subscribe a channer for message
	 */
